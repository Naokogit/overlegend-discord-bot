...
const {
    ...
    issueInput,
    topicInput,
} = require("../../modules/modalInputModule");
...
module.exports = {
    ...
    async execute(interaction, client) {
        if (interaction.customId === "ticketCreateSelect") {
            ...
            if (!ticketCategories[categorySelected]) return;
            ...
            const embed = new EmbedBuilder()
                .setTitle("Seleziona una sotto categoria")
                .setTimestamp()
            ...
            switch (categorySelected) {
                ...
                case "support":
                    ...
                    ticketCategories[categorySelected].subcategory.forEach(
                        (subcategory) => {
                            const subcategoryBtn = new ButtonBuilder()
                                ...
                                .setCustomId(
                                    `btnSubCategory_${subcategory.id}`
                                );
